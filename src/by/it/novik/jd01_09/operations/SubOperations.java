...
public class SubOperations implements ISubtraction{
     ...
     */
    public Variable subtraction(Variable operand1, Variable operand2) {
    ...
    private MatrixValue subtraction(DoubleValue value1, MatrixValue value2) {
    ...
    private VectorValue subtraction(DoubleValue value1, VectorValue value2) {
