 ...
 */
public class Text {
    public static String text = "Java is a general-purpose computer programming language that is concurrent, " +
            ...
            "machine (JVM) regardless of computer architecture. As of 2016, Java is one of " +
            "the most popular programming languages in use, particularly for client-server " +
            ...
            "and class libraries were originally released by Sun under proprietary licences. " +
            ...
            "for free by Oracle, although earlier versions are supported both by Oracle and " +
            "other companies on a commercial basis.";
}
