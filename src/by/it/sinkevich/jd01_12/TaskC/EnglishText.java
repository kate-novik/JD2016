...
/**
 * Utility class for a TaskC1. Words are the names of a different object.
 *
 * @author Sinkevich Denis
 */
class EnglishText {

    static final String TEXT = "Romeo and Juliet is a tragedy written by William Shakespeare early in his career about two young star-crossed " +
            "lovers whose deaths ultimately reconcile their feuding families. It was among Shakespeare's most popular plays " +
            ...
            "The plot is based on an Italian tale translated into verse as The Tragical History of Romeus and Juliet by Arthur Brooke in 1562, " +
            "and retold in prose in Palace of Pleasure by William Painter in 1567. Shakespeare borrowed heavily from both, " +
            ...
            "and Georg Benda's Romeo und Julie omitted much of the action, and added a happy ending. Performances in the 19th century, " +
            "including Charlotte Cushman's, restored the original text, and focused on greater realism. " +
            ...
            "In the 20th and into the 21st century, the play has been adapted in versions as diverse as George Cukor's 1935 film Romeo and Juliet, " +
            "Franco Zeffirelli's 1968 version Romeo and Juliet, and Baz Luhrmann's 1996 MTV-inspired Romeo + Juliet.";
}
