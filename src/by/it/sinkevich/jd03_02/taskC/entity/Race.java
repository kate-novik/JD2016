...
public class Race {
    ...
    public Race(int id, Timestamp time, String horse1, String horse2, String horse3, String horse4, String horse5, String horse6, String horse7, String horse8, String winner) {
        this.id = id;
        this.time = time;
        this.horse1 = horse1;
        this.horse2 = horse2;
